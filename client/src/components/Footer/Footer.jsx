    ...
    <div className="flex justify-around items-center p-4 border-t border-gray-200 fixed bottom-0 left-0 right-0 bg-white z-50">
      <Link to="/home">
        <div className="flex flex-col items-center justify-center">
          <button
            className={`cursor-pointer flex flex-col items-center text-xl px-4 py-2 rounded-full ${
              currentPath === "/home" ? "bg-black text-white" : "text-gray-400"
            }`}
          >
      ...
      <Link to="/favourite">
        <div className="flex flex-col items-center justify-center">
          <button
            className={`cursor-pointer flex flex-col items-center text-xl px-4 py-2 rounded-full ${
              currentPath === "/favourite" ? "bg-black text-white" : "text-gray-400"
            }`}
          >
      ...
      <Link to="/reminders">
        <div className="flex flex-col items-center justify-center">
          <button
            className={`cursor-pointer flex flex-col items-center text-xl px-4 py-2 rounded-full ${
              currentPath === "/reminders" ? "bg-black text-white" : "text-gray-400"
            }`}
          >
      ...
      <Link to="/account">
        <div className="flex flex-col items-center justify-center">
          <button
            className={`cursor-pointer flex flex-col items-center text-xl px-4 py-2 rounded-full ${
              currentPath === "/account" ? "bg-black text-white" : "text-gray-400"
            }`}
          >
